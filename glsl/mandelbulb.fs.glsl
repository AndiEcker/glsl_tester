...
void main( void ) {
  ...
  //vec4 result = vec4(1.0-vec3(c, c, c) - vec3(0.1024576534223, 0.02506, 0.2532)*m*0.8, alpha);
  vec4 result = vec4(1.0-vec3(0.5*c, 2.0*c, 0.5*c) - vec3(0.02506, 0.1024576534223, 0.2532)*m*0.8, alpha);
  if (tex_col_mix != 0.0) {
