...
# ae: no longer supported - see issue https://github.com/kivy/buildozer/issues/1186 (moved to requirements)
#garden_requirements = qrcode, xcamera, zbarcam

# (str) Presplash of the application
#presplash.filename = %(source.dir)s/data/presplash.png
presplash.filename = %(source.dir)s/img/app_icon.png

# (str) Icon of the application
#icon.filename = %(source.dir)s/data/icon.png
icon.filename = %(source.dir)s/img/app_icon.png
...
# ae: for apps with on_new_intent callback use "singleTask" (see https://github.com/kivy/python-for-android/issues/1076)
...
# ae: needed because service.py is not working/starting, so had to run the transfer service as attached/threaded in app
...
#p4a.branch = master
# ae: tried to fix 'env not a dict' bug in master see issue buildozer issue #1080 without success
p4a.branch = develop
